package com.ipx.units 
{
	...
	public class car_0 extends MovieClip
	{
		public var HP:Number = 15; /*describes the ammount of HP*/
		private var damagePerBullet:Number = 3.5; /*describes the ammount of damage target receives if hit*/
		private var fireFrequency:Number = 1050; /*bullets delay in ms*/
		private var movementSpeedStandard:Number = 0.9; /*describes car's standard movement speed*/
		...
		private var scaleWidth:Number = 60; /*describes car's width*/
		private var scaleHeigth:Number = 60; /*describes car's height*/
		...
		public function car_0(stageRef:Stage, target:tower_1) 
		{
