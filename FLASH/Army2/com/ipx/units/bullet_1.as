package com.ipx.units 
{
	...
	public class bullet_1 extends MovieClip 
	{
		...
		private var scaleWidth:Number = 13.28; /*describes bullet's width*/
		private var scaleHeigth:Number = 4; /*describes bullet's height*/
		private var rotationInRadians:Number;
		private var target:tower_1;
		private var damage:Number;
		
		public function bullet_1(stageRef:Stage, x:Number, y:Number, r:Number, target:tower_1, damage:Number) 
		{
			this.damage = damage;
