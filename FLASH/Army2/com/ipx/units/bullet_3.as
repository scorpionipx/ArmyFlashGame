package com.ipx.units 
{
	...
	public class bullet_3 extends MovieClip 
	{
		private var stageRef:Stage;
		private var bulletSpeed:Number = 5.5;
		private var scaleWidth:Number = 25.3; /*describes bullet's width*/
		private var scaleHeigth:Number = 5.6; /*describes bullet's height*/
		private var rotationInRadians:Number;
		private var target:tower_1;
		private var damage:Number;
		
		public function bullet_3(stageRef:Stage, x:Number, y:Number, r:Number, target:tower_1, damage:Number) 
		{
			this.damage = damage;
